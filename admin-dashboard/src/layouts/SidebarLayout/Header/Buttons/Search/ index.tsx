...
const DialogWrapper = styled(Dialog)(
  () => `
    .MuiDialog-container { hight: auto; }
    .MuiDialog-paperScrollPaper { max-hight: calc(100vh - 64px)}
  `
);
...
const SearchInputWrapper = styled(TextField)(
  ({theme}) => `
    ...
    .MuiInputBase-input { font-size: ${theme.typography.pxToRem(17)}; }
  `
);
                ...
                <ListItem button>
                  ...
                  <Box flex="1">
                    ...
                    <Typography
                      component="span"
                      variant="body2"
                      sx={{ color: (theme: Theme) => lighten(theme.palette.secondary.main, 0.5) }}
                    >
                      This page contains all the necessary information for managing
                    </Typography>
                  </Box>
